...
test('Scenario B: Walk-In Guest Lifecycle', async () => {
  const server = app.listen(PORT, async () => {
    try {
      await mongoose.connect('mongodb://localhost:27017/foodmesh_test_scenario_b');
      ...
      console.log('  [2] Customer places QR order...');
