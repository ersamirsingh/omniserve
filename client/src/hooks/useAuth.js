...
import { loginUser, googleLoginUser, registerUser, logoutUser, fetchCurrentUser, clearError } from '../store/authSlice';
...
export default function useAuth() {
  ...
  const googleLogin = useCallback((payload) => dispatch(googleLoginUser(payload)), [dispatch]);
  ...
  return { user, isAuthenticated, loading, authChecked, error, login, googleLogin, register, logout, fetchMe, clearErr };
}
