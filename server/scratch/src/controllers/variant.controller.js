...
export class VariantController {
    ...
    static async createVariant(req, res) {
        try {
            ...
            const variant = await VariantService.createVariant(req.user.tenantId, variantData, req.user.userId);
    ...
    static async updateVariant(req, res) {
        try {
            ...
            const updatedVariant = await VariantService.updateVariant(id, req.user.tenantId, updateData, req.user.userId);
            if (!updatedVariant) {
