...
export class PaymentController {
    ...
    static async createPayment(req, res) {
        try {
            ...
            const payment = await PaymentService.createPayment(req.user.tenantId, paymentData, req.user.userId);
    ...
    static async refundPayment(req, res) {
        try {
            ...
            const payment = await PaymentService.refundPayment(id, req.user.tenantId, refundTransactionId.trim(), req.user.userId);
            if (!payment) {
