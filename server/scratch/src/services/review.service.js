...
import { SentimentLabel } from '../enums/enums.js';
export class ReviewService {
    /**
     * Submit/Create a new review
     */
    static async createReview(tenantId, data, userId) {
     ...
     */
    static async getReviews(tenantId, filters) {
        const query = {
            tenantId: new Types.ObjectId(tenantId),
            isDeleted: false,
        };
     ...
     */
    static async getSentimentSummary(tenantId, outletId, outletIds) {
        const match = {
            tenantId: new Types.ObjectId(tenantId),
            isDeleted: false,
        };
     ...
     */
    static async deleteReview(id, tenantId, userId) {
