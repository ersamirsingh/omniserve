...
export class SubscriptionService {
     ...
     */
    static async createSubscription(tenantId, plan, amount, startDate, endDate, createdBy) {
     ...
     */
    static async getSubscriptionsByTenantId(tenantId, limit = 10, skip = 0) {
        const tenantObjectId = new Types.ObjectId(tenantId);
     ...
     */
    static async isSubscriptionActive(subscriptionId) {
     ...
     */
    static async updateSubscriptionStatus(subscriptionId, tenantId, status, updatedBy) {
     ...
     */
    static async cancelSubscription(subscriptionId, tenantId, updatedBy) {
        return await Subscription.findOneAndUpdate({
            _id: new Types.ObjectId(subscriptionId),
            tenantId: new Types.ObjectId(tenantId),
            isDeleted: false,
