...
export class MappingResolutionService {
     ...
     */
    static async resolveOutletId(tenantId, provider, externalOutletId) {
     ...
     */
    static async resolveMenuItemId(tenantId, outletId, provider, externalItemId) {
        const prov = String(provider).toUpperCase();
        if (prov === "QR" || prov === "WEBSITE" || prov === "POS" || prov === "QR_DINE_IN") {
     ...
     */
    static async resolveVariantId(tenantId, outletId, provider, externalVariantId) {
        const prov = String(provider).toUpperCase();
        if (prov === "QR" || prov === "WEBSITE" || prov === "POS" || prov === "QR_DINE_IN") {
     ...
     */
    static async resolveAddonId(tenantId, outletId, provider, externalAddonId) {
        const prov = String(provider).toUpperCase();
        if (prov === "QR" || prov === "WEBSITE" || prov === "POS" || prov === "QR_DINE_IN") {
