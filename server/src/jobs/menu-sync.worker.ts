...
import { SyncEngineService } from "../modules/integration/sync-engine.service.js";
...
export async function menuSyncWorker(event: IIntegrationEventQueue): Promise<void> {
  let connections: any[] = [];
